...
class CartController extends Controller {
   ...
   public function cartdetail(){
       ...
       $res_curr=explode("-",$setting->default_currency);
        ...
        return view("user.product.mycart")->with("header_menu",$getcat)->with("productdata",$productdata)->with("mywish",$mywish)->with("shipping",$shipping)->with("setting",$setting)->with("lang",$lang);
   }
