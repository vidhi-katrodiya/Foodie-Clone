...
class CouponController extends Controller {
      ...
      public function index(){
            $lang = Lang_core::all();
           return view("admin.coupon.default")->with("lang",$lang);
      }
      ...
      public function addcoupon(){
        $lang = Lang_core::all();
         return view("admin.coupon.addcoupon")->with("lang",$lang);
      }
      ...
      public function savecoupon(Request $request){        
          ...
          foreach ($language as $k) {
              $this->file_meta_update_payment_key($data->id,$k->code,"name",$request->get("name_".$k->code),"Coupon");
          }
          return $data->id;
      }
      ...
      public function editcoupon($id){
       ...
       //   echo "<pre>";print_r($data);exit;
        return view("admin.coupon.addcoupon")->with("data",$data)->with("lang",$lang);
      }
