                              ...
                              <div class="gold-members p-3">
                                <span class="count-number float-right">
                                  ...
                                  @if($count)
                                      ...
                                      <a  id="add" class="add btn btn-outline-secondary btn-sm right inc"  type="button" data-bs-toggle="modal" data-bs-target="#reapeat" ><i class="icofont-plus"  data-field="quantity"></i></a>
    ...
    $.ajax({
      ...
      data:{
        ...
        console.log(json.status);
          ...
          if(json.status == 0){
             $("#error_sts").empty();
            $("#error_sts").append('<div class="sufee-alert alert with-close alert-danger alert-dismissible fade show" style="margin: 20px; font-weight:500; width:460px;"><ul><li>'+json.error+'</li></ul><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
          } 
          alert(json.status);
          if(json.status == 1){
