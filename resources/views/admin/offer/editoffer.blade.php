@extends('admin.index') 
@section('title')
{{__("messages.Edit Offer")}} || {{__("messages.Admin")}}
@endsection
@section('content')
                                    ...
                                    @foreach($lang as $l)
                                        <div class="tab-pane fade {{$i==0?'show active':''}}" id="{{$l->code}}" role="tabpanel" aria-labelledby="{{$l->code}}-tab">
                                            <div class="form-group col-md-12 paddiv">
                                                ...
                                                <input type="text" id="title_{{$l->code}}" placeholder="Enter Title" class="form-control" name="title_{{$l->code}}" value="{{$data->$title}}" required>
                                            </div>
                                           <div class="form-group col-md-12 paddiv">
                                                <label for="name" class=" form-control-label">
                                                 ...
                                                 <?php $main_title = "main_title_".$l->code; ?>
                                                <input type="text" id="main_title_{{$l->code}}" placeholder="Enter Main Title" class="form-control" name="main_title_{{$l->code}}" required value="{{$data->$main_title}}">
                                            </div>
                                        </div>
                                       <?php $i++; ?>
                                    @endforeach
