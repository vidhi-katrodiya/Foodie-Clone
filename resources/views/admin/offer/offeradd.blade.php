@extends('admin.index') 
@section('title')
{{__("messages.Offer Add")}} || {{__("messages.Admin")}}
@endsection
@section('content')
                    ...
                    <div id="pay-invoice">
                        <div class="card-body">
                            ...
                            <form action="{{url('admin/storeofferdata')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    @foreach($lang as $l)
                                        <div class="tab-pane fade {{$i==0?'show active':''}}" id="{{$l->code}}" role="tabpanel" aria-labelledby="{{$l->code}}-tab">
                                            <div class="form-group col-md-12 paddiv">
                                                ...
                                                <input type="text" id="title_{{$l->code}}" placeholder="Enter Title" class="form-control" name="title_{{$l->code}}" required>
                                            </div>
                                            <div class="form-group col-md-12 paddiv">
                                                <label for="name" class=" form-control-label">
                                                ...
                                                <input type="text" id="main_title_{{$l->code}}" placeholder="Enter Main Title" class="form-control" name="main_title_{{$l->code}}" required>
                                            </div>
                                        </div>
                                       <?php $i++; ?>
                                    @endforeach
                                ...
                                @if($offer_type==1)
                                        <div class="form-group col-md-12 paddiv">
                                             <label for="name" class=" form-control-label">{{__('messages.mobile_banner')}}<span class="reqfield">*</span></label>
                                            @if($offer_type==1)
