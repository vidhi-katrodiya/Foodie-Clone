@extends('admin.index')
@section('title')
{{__("messages.Delivery")}} || {{__("messages.Admin")}}
@endsection
@section('content')
         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="table-responsive dtdiv">
                  <table id="boytb" class="table table-striped table-bordered dttablewidth" >
                     <thead>
                        <tr>
      ...
      <div class="modal-content">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form name="menu_form_category" action="{{url('admin/add_delivery_boy')}}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" placeholder="{{__('messages.phone')}}" name="phone" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="col-md-12">
                     <div class="col-md-6">
                          ...
                          @if(Session::get("is_demo")=='1')
                              <button type="button" onclick="disablebtn()" id="payment-button"  class="btn btn-primary btn-md form-control">{{__('messages.Submit')}}</button>
                          @else
                               <button  class="btn btn-primary btn-md form-control" id="payment-button" type="submit" value="Submit">{{__('messages.add')}}</button>
                          @endif
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form name="menu_form_category" action="{{url('admin/update_delivery_boy')}}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}
                  ...
                  <div class="form-group">
                     <label>{{__('messages.phone')}}</label>
                     <input type="text" class="form-control" placeholder="{{__('messages.phone')}}" name="phone" required id="edit_phone">
                  </div>
                  <div class="form-group">
                     <label>{{__('messages.email')}}</label>
                  ...
                  <div class="col-md-12">
                     <div class="col-md-6">
                          @if(Session::get("is_demo")=='1')
                              <button type="button" onclick="disablebtn()" id="payment-button"  class="btn btn-primary btn-md form-control">{{__('messages.Submit')}}</button>
                          @else
                               <button  class="btn btn-primary btn-md form-control" id="payment-button" type="submit" value="Submit">{{__('messages.update')}}</button>
                          @endif
