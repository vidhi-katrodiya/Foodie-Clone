@extends('admin.index')
@section('title')
{{__("messages.Reposrts")}} || {{__("messages.Admin")}}
@endsection
@section('content')
<style>
               ...
               <div id="pay-invoice">
                  ...
                  <div id="filter_section">
                     <div class="form-group has-success report-date">
                        ...
                        <input type="text" class="form-control" name="start_date"  onchange="check_start_date()" id="start_date" >
                     ...
                     <div class="form-group has-success report-date1">
                        ...
                        <input type="text" class="form-control"  onchange="check_end_date()" name="end_date" id="end_date">
                     ...
                     <div class="form-group has-success">
                        ...
                        <select name="order_status" id="order_status" class="form-control">
                           ...
                           <option value="7">{{__("messages.completed")}}</option>
                           <option value="4">{{__("messages.on_hold")}}</option>
                           <option value="0">{{__("messages.pending")}}</option>
                           <option value="3">{{__("messages.processing")}}</option>
                           <option value="8">{{__("messages.refunded")}}</option>
                           <option value="6">{{__("messages.out_of_delivery")}}</option>
                        </select>
                     </div>
                     <div class="form-group has-success">
                  ...
                  <div class="form-group florig" >
                     <button class="btn btn-primary btn-flat m-b-30 m-t-30" onclick="filterdata()">
               ...
               <div id="pay-invoice">
                  <div id="result_section">
                     ...
                     <div class="table-responsive dtdiv repo">
                        <div class="input-group mb-2"style="width: auto;margin-left: 154px;position: absolute;font-weight: 400;">
                            <div class="input-group-prepend">
                              <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                            </div>
                            <?php $frist_date=date('F 01,Y').' to '.date('F t,Y');?>
                            <input type="text" style="width: 300px;" class="form-control" required  name="name_lang" value="<?= $frist_date?>" id="date_duration" readonly>
                        </div>
                    
                        <input type="hidden" name="defualt_date" id="defualt_date" value="<?= $frist_date?>" >
                        ...
                        <table id="add_customer_report" class="table table-striped table-bordered dttablewidth disno">
                           <thead>
                              <tr>
                                 <th>Id</th>
                                 <th>Created {{__('messages.date')}}</th>
                                 <th>{{__('messages.cus_name')}}</th>
                                 <th>{{__('messages.cus_email')}}</th>
                              </tr>
                           </thead>
