@extends('admin.index')
@section('title')
{{__("messages.Help")}} || {{__("messages.Admin")}}
@endsection
@section('content')
                                    ...
                                    @foreach($lang as $l)
                                        <div class="tab-pane fade {{$i==0?'show active':''}}" id="{{$l->code}}" role="tabpanel" aria-labelledby="{{$l->code}}-tab">
                                            <div class="form-group col-md-12 paddiv" >
                                                ...
                                                <input name="topicname_{{$l->code}}" type="text" class="form-control" required  placeholder="{{__('messages.topicname')}}">
                                             </div>
                                        </div>
                                       <?php $i++; ?>
                                    @endforeach
                                 ...
                                 <div class="tab-content p-1" id="myTabContent">
                                    ...
                                    @foreach($lang as $l)
                                        <div class="tab-pane fade {{$i==0?'show active':''}}" id="tab{{$l->code}}" role="tabpanel" aria-labelledby="{{$l->code}}-tab">
                                            <div class="form-group col-md-12 paddiv" >
                                                <label for="cc-payment" class="control-label mb-1">{{__('messages.topicname')}}<span class="reqfield">*</span></label>
                                                <input id="topicname_{{$l->code}}" name="topicname_{{$l->code}}" type="text" class="form-control" required  placeholder="{{__('messages.topicname')}}">
                                             </div>
                                        </div>
                                       <?php $i++; ?>
                                    @endforeach
