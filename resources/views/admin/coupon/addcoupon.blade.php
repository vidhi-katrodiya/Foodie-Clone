@extends('admin.index') 
@section('title')
{{__("messages.Coupons")}} || {{__("messages.Admin")}}
@endsection
@section('content')
            ...
            <div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab">
               <div class="cmr1">
                                    ...
                                    @foreach($lang as $l)
                                        <div class="tab-pane fade {{$i==0?'show active':''}}" id="{{$l->code}}" role="tabpanel" aria-labelledby="{{$l->code}}-tab">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input id="name_{{$l->code}}" name="name_{{$l->code}}" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?=isset($data->$name)?$data->$name:''; ?>" placeholder="{{__('messages.name')}}">
                                             </div>
                  ...
                  <div class="form-group col-md-12" >
                      ...
                      @else
                            <button  class="florig btn btn-primary" type="submit">{{__('messages.next')}}</button>
                      @endif                   
                  </div>
               </form>
               </div>
