         ...
         <div class="container">
            <div class="login-content">
               ...
               <div class="login-form">
                  ...
                  <form action="{{url('postsellerlogin')}}" method="post">
                     {{csrf_field()}}
                     <div class="form-group">
                        <label>{{__('messages.email')}}</label>
                        <input type="email" class="form-control" placeholder="{{__('messages.email')}}" required name="email" id="email" value="clubsteakhouse@gmail.com">
                     </div>
                     <div class="form-group">
